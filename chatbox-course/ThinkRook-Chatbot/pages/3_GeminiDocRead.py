...
@st.cache_resource
def get_llm(model_name: str, api_key: str, temperature: float = 0.3) -> ChatGoogleGenerativeAI:
...
def create_rag_processor(uploaded_file, gemini_api_key: str) -> Optional[FAISS]:
    """
...
def main():
    ...
    st.caption("RAG for documents | Pandas Agent for data files")
            ...
            if st.session_state.document_name != uploaded_file.name:
                if not gemini_api_key:
                    ...
                    with st.spinner("Processing file... This may take a moment."):
                        ...
                        llm = get_llm(model_name, gemini_api_key, temperature=0.3)
                ...
                with st.spinner("Thinking..."):
                    try:
                        ...
                        if st.session_state.file_type in ["application/pdf", "application/vnd.openxmlformats-officedocument.wordprocessingml.document"]:
                            ...
                            llm = get_llm(model_name, gemini_api_key, temperature=0.5)
